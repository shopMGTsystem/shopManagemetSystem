      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item active"><a href="user_card_info.jsp"><i class="mdi mdi-file-account"></i> 会员卡信息</a></li>
      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 会员卡信息 </span>
          </div>
              ...
              <div class="card-body">
                ...
                <form method="post" action="#!" class="site-form">
                  <div class="form-group">
                    <label for="cid">会员卡号</label>
                    <input type="text" class="form-control" name="cid" id="cid"  disabled="disabled" />
                  </div>
                  <div class="form-group">
                    <label for="level">会员卡等级</label>
                    <input type="text" class="form-control" name="level" id="level" placeholder="普通卡 银卡 金卡 钻石卡" disabled="disabled">
                  </div>
                  <div class="form-group">
                    <label for="point">现有积分</label>
                    <input type="text" class="form-control" name="point" id="point" placeholder="现有积分"  disabled="disabled">
                  </div>
...
$(document).ready(function(e) {
	...
	$.getJSON("card/findCardInfoByUsername",params,function(card) {
		$("#cid").val(card.cID);
		$("#point").val(card.point);
		if (card.level == 1) {
			$("#level").val("普通卡");//不打折
